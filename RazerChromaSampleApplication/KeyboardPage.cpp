...
void CKeyboardPage::OnBnClickedButtonLoadingAnimation()
{
    ...
    if(EffectId == GUID_NULL)
    {
        ...
        for(UINT r=0; r<ChromaSDK::Keyboard::v2::MAX_ROW; r++)
        {
            for(UINT c=0; c<3; c++)
            {
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(ChromaSDK::Keyboard::CHROMA_CUSTOM2, &Effect, &Frame1);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(ChromaSDK::Keyboard::CHROMA_CUSTOM2, &Effect, &Frame2);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(ChromaSDK::Keyboard::CHROMA_CUSTOM2, &Effect, &Frame3);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(ChromaSDK::Keyboard::CHROMA_CUSTOM2, &Effect, &Frame4);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(ChromaSDK::Keyboard::CHROMA_CUSTOM2, &Effect, &Frame5);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(ChromaSDK::Keyboard::CHROMA_CUSTOM2, &Effect, &Frame6);
...
void CKeyboardPage::OnBnClickedButtonActiveKeys()
{
    ...
    if(IsEqualGUID(EffectId, GUID_NULL))
    {
        ...
        ChromaSDK::Keyboard::v2::CUSTOM_EFFECT_TYPE Keys = {};
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Keys, &Frame0);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame1);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame2);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame3);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame4);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame5);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame6);
        ...
        for (int i = 0; i<::v2::MAX_COLUMN; i++)
        {
            Effect.Color[6][i] = ORANGE;
        }

        Effect.Color[0][20] = ORANGE;

        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame7);
        ...
        for (int i = 0; i<::v2::MAX_COLUMN; i++)
        {
            Effect.Color[6][i] = RGB(0.1 * GetRValue(ORANGE),
                0.1 * GetGValue(ORANGE),
                0.1 * GetBValue(ORANGE));
        }
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame8);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame9);
        ...
        g_ChromaSDKImpl.CreateKeyboardEffectImpl(CHROMA_CUSTOM2, &Effect, &Frame10);
